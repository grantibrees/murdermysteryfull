  ...
  actions: {
    initializeSocket({ commit, dispatch }) {
      ...
      socket.on("CONNECTED", (data) => {
        console.log(data.message + " Time to HACK THE PLANET");
      });

      // NOTE: registers event listeners for emits from socketservice
      // Below are all examples from capstone/SongScoop:
